/* How to invoke writeExternal and readExternal methods of parent class.
...
class Account implements Externalizable
{
	...
	public void writeExternal(ObjectOutput out) throws IOException {
		...
		System.out.println("in writeExternal method of Account");
		out.writeInt(id);
		out.writeUTF(info);
	...
	public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
		// TODO Auto-generated method stub
		System.out.println("in readExternal method of Account");
		id=in.readInt();
		info=in.readUTF();
...
class BankDetails implements Externalizable
{
	...
	public void writeExternal(ObjectOutput out) throws IOException {
		// TODO Auto-generated method stub
		System.out.println("in writeExternal method of BankDetails");
		out.writeUTF(type);
	...
	public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
		// TODO Auto-generated method stub
		System.out.println("in readExternal method of BankDetails");
		type=in.readUTF();
...
class MyAccount extends Account  { 
	...
	public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    	...
    	pwd=new String(arr);
    	username=in.readUTF();
    	details=(BankDetails) in.readObject();
    	super.readExternal(in);
	}
} 
  
public class ExternalizableDemo5 { 
